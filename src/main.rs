...
impl Register {
    ...
    fn get_reg16(&self) -> u16 {
        unsafe { self.reg16 }
    }

    fn get_reg8_h(&self) -> u8 {
        unsafe { self.reg8[1] }
    }

    fn get_reg8_l(&self) -> u8 {
        unsafe { self.reg8[0] }
    }

    fn set_reg16(&mut self, value: u16) {
        self.reg16 = value;
    }

    fn set_reg8_h(&mut self, value: u8) {
        unsafe {
            self.reg8[1] = value;
        }
    }

    fn set_reg8_l(&mut self, value: u8) {
        unsafe {
            self.reg8[0] = value;
        }
    }

    fn add_r16_r16(&mut self, rh: &Register) {
        self.set_reg16(self.get_reg16() + rh.get_reg16());
    }

    fn add_r16_i8(&mut self, rh: u8) {
